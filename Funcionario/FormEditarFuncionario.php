  ...
  <body>
    ...
    <div class="formulario">
      <form method="post" action="EditarFuncionario.php">
          ...
          <!-- NOVO CAMPO TIPO DE FUNCIONÁRIO -->
          <label>Tipo de Funcionário</label><br>
          <select name="tipo_funcionario" required>
            <option value="Administrador" <?= $campo["tipo_funcionario"] == 'Administrador' ? 'selected' : '' ?>>Administrador</option>
            <option value="Recepcionista" <?= $campo["tipo_funcionario"] == 'Recepcionista' ? 'selected' : '' ?>>Recepcionista</option>
            <option value="Cabeleireiro" <?= $campo["tipo_funcionario"] == 'Cabeleireiro' ? 'selected' : '' ?>>Cabeleireiro</option>
          </select>
          <br><br>
