...
-- Criação das Foreign Keys (após ter certeza que as tabelas referenciadas existem)
ALTER TABLE `tb_agendamentos`
ADD CONSTRAINT `fk_agendamento_funcionario`
FOREIGN KEY (`id_funcionario`)
REFERENCES `tb_funcionarios`(`id_funcionarios`)
ON DELETE CASCADE;

ALTER TABLE `tb_agendamentos`
ADD CONSTRAINT `fk_agendamento_pagamento`
FOREIGN KEY (`id_pagamento`)
REFERENCES `tb_pagamentos`(`id_pagamentos`)
ON DELETE CASCADE;
