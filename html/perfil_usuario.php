...
<body>
    ...
    <main class="profile-container">
        ...
        <section class="profile-section">
            <h2>Meus Dados</h2>
            <form class="profile-form" action="perfil_usuario.php" method="post" action="../crud/EditarClinte.php">
        ...
        <section class="profile-section">
            ...
            <ul class="orders-list">
                <li>
                    Pedido #2024 - Shampoo e Máscara de Hidratação - Entregue
                    <div class="actions">
                        <button class="cancel-btn">Cancelar</button>
                    </div>
                </li>
                <li>
                    Pedido #2023 - Kit Cabelos Loiros - Em andamento
                    <div class="actions">
                        <button class="cancel-btn">Cancelar</button>
                    </div>
                </li>
