...
-- Comentário: 
-- A tabela 'tb_estoque' armazena as quantidades dos produtos disponíveis, 
-- associando a fornecedores e com registro da última atualização.
...
-- Comentário:
-- Tabela com dados detalhados dos funcionários, incluindo dados pessoais e contratuais.
...
-- NOVA TABELA ADICIONADA: Controle de última atualização do estoque por produto
...
-- Comentário:
-- Essa tabela facilita rastrear rapidamente a última vez que o estoque de cada produto foi atualizado,
-- otimizando consultas que precisem dessa informação sem varrer todo o histórico.
