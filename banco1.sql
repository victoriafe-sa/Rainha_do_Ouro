...
ALTER TABLE tb_pedidos ADD COLUMN cep VARCHAR(20) NULL AFTER id_cliente;
...
ALTER TABLE tb_agendamentos ADD COLUMN id_cliente INT NOT NULL;
ALTER TABLE tb_agendamentos ADD FOREIGN KEY (id_cliente) REFERENCES tb_clientes(id_clientes);

ALTER TABLE `db_rainhadoouro`.`tb_clientes` 
ADD COLUMN `genero` VARCHAR(45) NOT NULL AFTER `data_nascimento`;
