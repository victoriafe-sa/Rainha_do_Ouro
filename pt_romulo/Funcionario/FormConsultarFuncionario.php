    ...
    <body>
        ...
        >
            <tr>
                ...
                <td align="center"><strong>Tipo de Funcionário</strong></td> <!-- NOVO -->
            ...
            <?php
                ...
                while ($campo = mysqli_fetch_array($selecionar)) { ?>
                    <tr>
                        ...
                        <td align="center"><?= $campo["tipo_funcionario"] ?></td> <!-- NOVO -->
                        <td align="center"><a href="FormEditarFuncionario.php?editarid=<?= $campo['id_funcionarios'] ?>">Editar</a></td>
                        <td align="center"><i><a href="ExcluirFuncionario.php?p=excluir&funcionario=<?= $campo['id_funcionarios'] ?>">Excluir</a></i></td>
                    </tr>
            <?php } ?>
        </table><br>
